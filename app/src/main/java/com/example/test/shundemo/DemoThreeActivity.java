...
/**
 * Created by xushun on 2019/4/10.
 */

public class DemoThreeActivity extends Activity implements ProcessView3.OnItemClickListener {
    @BindView(R.id.process_view)
    ProcessView3 processView;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.demo_three);
        ButterKnife.bind(this);
        processView.setOnItemClickListener(this);
        processView.setData(getTextShow(), getMeasureRecorde());
    }
